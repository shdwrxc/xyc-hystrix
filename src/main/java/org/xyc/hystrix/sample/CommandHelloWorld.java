...
public class CommandHelloWorld extends HystrixCommand<String> {
    ...
    public static class UnitTest {
        ...
        @Test
        public void testOwn() {
            CommandHelloWorld helloWorld = new CommandHelloWorld("wks");
            String result = helloWorld.execute();
            //            String result1 = helloWorld.execute();
        ...
        public void testAsynchronous1() throws Exception {
            ...
            fs.get(100, TimeUnit.MILLISECONDS);
            assertEquals("Hello World!", new CommandHelloWorld("World").queue().get(100, TimeUnit.MILLISECONDS));
